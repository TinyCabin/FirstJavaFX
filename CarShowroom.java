...
public class CarShowroom implements Serializable {
    ...
    Map<Vehicle, Integer> inventory; //ilosc pojazdow
    ...
    public List<Vehicle> sortByName() {
        //porównuje  najpierw  getBrand() potem getModel().
    ...
    public Vehicle max() {
        ...
        //Collections.max() do znalezienia max ilości pojazdu w mapie
    ...
    public Map<Vehicle, Integer> getInventory() {
        return inventory;
    }
